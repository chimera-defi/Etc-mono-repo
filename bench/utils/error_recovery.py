...
FALLBACK_MODELS = {
    'lfm2.5-thinking:1.2b': ['lfm2.5:latest', 'qwen2.5:3b'],
    'lfm2.5:latest': ['qwen2.5:3b', 'mistral:7b'],
    'qwen2.5:3b': ['mistral:7b', 'llama3:8b'],
    'ministral-3:latest': ['mistral:7b', 'llama3:8b'],
