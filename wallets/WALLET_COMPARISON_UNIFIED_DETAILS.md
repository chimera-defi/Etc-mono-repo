...
| **Desktop** | ✅ App / ✅ Proxy / 🌐 Browser / ❌ | Desktop application type. ✅ App = Native desktop app (e.g., Rabby, Ledger Live) | ✅ Proxy = Desktop app with browser proxy injection (Frame-style — unique architecture where desktop app injects into browser via localhost proxy) | 🌐 Browser = Wallet built into browser (Brave) | ❌ = No desktop app. See [Desktop App Wallets section](#-desktop-app-wallets-frame-like-architecture) for details |
