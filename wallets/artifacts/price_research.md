...
| --- | --- | --- | --- |
| Ledger Nano X | 99 | USD | https://shop.ledger.com/products/ledger-nano-x |
...
Notes:
- Software wallets, ramps, and most cards are free or fee-based and are intentionally excluded from Merchant Center feed.
- Re-verify excluded items manually if provider pages expose structured pricing in the future.
