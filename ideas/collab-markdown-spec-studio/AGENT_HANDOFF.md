...
2. Collaboration-Core Agent
   - Scope: `SPEC.md`
   - Prompt: "Define realtime collaboration state model, CRDT/editor boundary, event contracts, and merge invariants that are deterministic under concurrent edits."
