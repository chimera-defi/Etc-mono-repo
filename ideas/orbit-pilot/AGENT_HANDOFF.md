...
1. Registry Agent
   - Scope: `PLATFORM_MATRIX.md`, bundled seed list in `apps/orbit-pilot/src/orbit_pilot/bundled/seed_platforms.yaml`
   - Objective: normalize platform metadata and mode/risk assignments.
2. Orchestration Agent
   - Scope: `SPEC.md`, `SYSTEM_PROMPT.md`, `apps/orbit-pilot/src/orbit_pilot/`
