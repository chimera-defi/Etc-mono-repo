...
**Implementation:** [`apps/orbit-pilot/`](../../apps/orbit-pilot/) — humans [`HUMAN_GUIDE.md`](../../apps/orbit-pilot/HUMAN_GUIDE.md), agents [`AGENTS.md`](../../apps/orbit-pilot/AGENTS.md). **Claude Code:** [`.claude/skills/orbit-pilot-operator/SKILL.md`](../../.claude/skills/orbit-pilot-operator/SKILL.md).
